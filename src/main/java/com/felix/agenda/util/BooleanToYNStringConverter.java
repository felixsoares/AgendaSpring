...
/**
 * Converts a Boolean entity attribute to a single-character Y/N string that
 * will be stored in the database, and vice-versa
 * 
 * @author jtough
 */
public class BooleanToYNStringConverter implements AttributeConverter<Boolean, String> {
	 ...
	 * otherwise it will return "N" when the parameter is Boolean.FALSE. A null
	 * input value will yield a null return value.
	 * 
	 * @param b Boolean
	 */
	@Override
	 ...
	 * actually look for "N") for any other non-null string. A null input value will
